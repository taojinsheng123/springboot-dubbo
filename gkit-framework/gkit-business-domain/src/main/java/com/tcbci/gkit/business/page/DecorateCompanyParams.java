 ...
 *
 */
public class DecorateCompanyParams extends PageParams {

	private String[] keywords;// 关键字(企业名称,ID)

	private String[] decorateCompanyIds;
	...
	public String[] getDecorateCompanyIds() {
		return decorateCompanyIds;
	}

	public void setDecorateCompanyIds(String[] decorateCompanyIds) {
		this.decorateCompanyIds = decorateCompanyIds;
	}
