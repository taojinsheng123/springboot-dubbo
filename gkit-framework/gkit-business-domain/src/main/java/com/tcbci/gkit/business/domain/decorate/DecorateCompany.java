...
/**
 * T_decorate_company 实体类 Tue Sep 05 19:47:59 CST 2017 heqichun
 */

public class DecorateCompany implements Serializable {
	...
	private Integer createUserScope;// 创建用户类型 0外网1内网
	private Integer editUserScope;// 编辑人类型 0.前台 1.后台
	private Integer submitUserScope;// 提交用户类型 0外网1内网
